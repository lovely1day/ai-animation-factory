"use client";
// EyeTab — عيون: ES, EZ, EC, EP, EB
// ملاحظة: يُستدعى من FaceTab أو كـ tab منفصل
...
interface EyeTabProps { cb: UseCharacterBuilder }
...
export function EyeTab({ cb }: EyeTabProps) {
  return (
    <div className="space-y-8" dir="rtl">
      ...
      <section>
        <SectionTitle ar="نقش القزحية" en="Iris Pattern" />
        <SegmentSelector
          items={IRIS_PATTERNS}
