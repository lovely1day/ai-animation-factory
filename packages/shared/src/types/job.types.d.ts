export type JobType = 'idea_generation' | 'script_writing' | 'scene_prompts' | 'image_generation' | 'animation' | 'voice_generation' | 'music_generation' | 'video_assembly' | 'subtitle_generation' | 'thumbnail_generation';
