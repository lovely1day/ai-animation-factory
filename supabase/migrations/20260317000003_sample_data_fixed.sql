-- Insert Sample Data for Testing (FIXED)
...
SELECT 'اجتماع الزوم', 'كوارث اجتماعات الزوم', 'comedy', 'adults', 'processing', project2.id, 2, 1, 80, 12, 170, 'voice', 'pending', 45, '["script", "images"]'::jsonb
FROM project2;
...
-- Insert sample generation jobs (FIXED - using valid status values)
...
INSERT INTO generation_jobs (episode_id, job_type, queue_name, status, progress)
SELECT id, 'voice_generation', 'voice', 'pending', 45
FROM episodes WHERE title = 'اجتماع الزوم';
